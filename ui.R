...
shinyUI(dashboardPage(
    ...
    dashboardSidebar(width = 450, 
            ...
            conditionalPanel('input.action_type == "Get plants"',
                             ...
                             conditionalPanel('input.maximizer == "Phenological coverage"',
                                              dateRangeInput('dateRange1',
                                                             label = 'Do you want to select a flowering period?',
                                                             start = "2020-03-01", end = "2020-09-01", format = "dd/mm/yy"
                                              )),
                             checkboxGroupInput(inputId = "native",
                                                label = 'Do you want to use native plants only?',
                                                choices = c("Native", "Non-Native and Non-Invasive", "Non-Native and Invasive")),
        ...
        dashboardBody(
            ...
            tabsetPanel(type = "tabs",
                        ...
                        tabPanel("Contributors and contact", 
                                 ...
                                 p("The data for this app was collected by Dr. Elizabeth Elle, students, and postdocs from the Elle lab."),
